...
[![tests](https://github.com/chauhansudhanshu511-cell/NewsLens/actions/workflows/tests.yml/badge.svg)](https://github.com/chauhansudhanshu511-cell/NewsLens/actions/workflows/tests.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)

[![Open in Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://newslens-fakenews.streamlit.app/)

**🔗 Live demo:** https://newslens-fakenews.streamlit.app/  
**📦 Repository:** https://github.com/chauhansudhanshu511-cell/NewsLens
...
### 1. Get the code
```bash
git clone https://github.com/chauhansudhanshu511-cell/NewsLens.git
cd NewsLens
```
...
2. In the project folder (with the trained model in `models/`):
   ...
   git remote add origin https://github.com/chauhansudhanshu511-cell/NewsLens.git
...
3. Fill in **Repository** `chauhansudhanshu511-cell/NewsLens`, **Branch** `main`,
